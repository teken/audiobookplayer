...
import TorrentService from "./uiservices/torrent";
...
import {TorrentContext} from "./components/downloads/withTorrent";
...
const stateService = new StateService(user);

const torrent = new TorrentService();
